...
} from "../../utils/preserveQueryParameters";
...
function WorkList({
	...
	const defaultSortValues =
		shouldUseDefaultSort && canSort
			...
			: {};
	const { customizationService, userAuthenticationService } =
	...
	menuOptions.push({
		...
		onClick: async () => {
			...
			const proxyLogoutUrl =
				"/oauth2/sign_out?rd=" + encodeURIComponent(finalLogoutUrl);
	...
	const dataSourceConfigurationComponent =
