        ...
        <Popover.PopoverTrigger asChild>
          <div className="relative w-full">
            ...
            <input
              ...
              className={cn(
                'border-inputfield-main focus:border-inputfield-focus h-[32px] w-full justify-start rounded border bg-background py-[6.5px] pl-[6.5px] pr-[6.5px] text-left text-base font-normal hover:bg-background hover:text-white',
        ...
        <Popover.PopoverTrigger asChild>
          <div className="relative w-full">
            ...
            <input
              ...
              className={cn(
                'border-inputfield-main focus:border-inputfield-focus h-full w-full justify-start rounded border bg-background py-[6.5px] pl-[6.5px] pr-[6.5px] text-left text-base font-normal hover:bg-background hover:text-white',
